import { Helvetica_Bold, neueHass } from '@/utils/font'
    ...
    <>
      <div className="landing-container h-full flex flex-col w-full place-content-between p-4 lg:p-10">
        <div className="brand-info flex justify-end">
          <h2 className={`${Helvetica_Bold.className} lg:w-3/6 text-4xl lg:text-4xl xs:text-2xl lg:mt-32 mt-44`}>We craft unique and engaging visual content in our creative photography studio to tell your stories.
          </h2>
        </div>
        <div className={`branding ${neueHass.className}`}>
          <div className="tagline-anim">
            <h1 className={`text-8xl lg:text-9xl xs:text-7xl ${neueHass.className} font-medium`}>archiive</h1>
